...
{
    [TestClass]
    public class ChessEngineStockfishTest
    {
        ...
        private ChessEngineStockfish _chessEngine;
        public ChessEngineStockfishTest()
        {
            _chessEngine = new ChessEngineStockfish();
        }
