...
{
    [TestClass]
    public class ChessEngine3SSTest
    {
        ...
        private ChessEngine3SS _chessEngine;
        public ChessEngine3SSTest()
        {
             _chessEngine = new ChessEngine3SS();
        }
      ...
      "\nKing;e8;Black;False;True;True;True";
            ...
            {
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardFormPawnListCESS(pawnList));
                //Positions final du cavalier Blach ne doit pas etre  ni "a7" ni "c7"
      ...
      "\nRook;h8;Black;False;False;False;False";
            ...
            {
                // var nodeResult = chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardFormPawnListCESS(pawnList), true,null);
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardFormPawnListCESS(pawnList));
    ...
    */
        ...
        * */
        ...
        public void T95BLeCavalierBlanchDoitAttaquerEnF2()//OK IF L3 (100)
        {
            ...
            {
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardFormPawnListCESS(pawnList), 3);
                // Assert.AreEqual(nodeResult.BestChildPosition, "f2");
        ...
        //    using (var chessEngine = new ChessEngine22())
        //    {
        //        var nodeResult = chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardFormPawnListCESS(pawnList),6);
        ...
        public void T147_B_NotC8toC5()
        {
            ...
            var pawnList = Chess2Utils.LoadFromDirectorie(testPath);
            {
                ...
                //LEVEL 7
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardFormPawnListCESS(pawnList),7);
