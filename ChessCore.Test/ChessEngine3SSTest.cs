...
namespace ChessCore.Test
{
    ...
    public class ChessEngine3SSTest
    {
      ...
      "\nKing;e8;Black;False;True;True;True";
            ...
            {
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardSSCEFormPawnList(pawnList));
                //Positions final du cavalier Blach ne doit pas etre  ni "a7" ni "c7"
      ...
      "\nRook;h8;Black;False;False;False;False";
            ...
            {
                // var nodeResult = chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardSSCEFormPawnList(pawnList), true,null);
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardSSCEFormPawnList(pawnList));
    ...
    */
        ...
        * */
        ...
        public void T95BLeCavalierBlanchDoitAttaquerEnF2()//OK IF L3 (100)
        {
            ...
            {
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardSSCEFormPawnList(pawnList), 3);
                // Assert.AreEqual(nodeResult.BestChildPosition, "f2");
        ...
        //    using (var chessEngine = new ChessEngine22())
        //    {
        //        var nodeResult = chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardSSCEFormPawnList(pawnList),6);
        ...
        public void T147_B_NotC8toC5()
        {
            ...
            var pawnList = Chess2Utils.LoadFromDirectorie(testPath);
            {
                ...
                //LEVEL 7
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardSSCEFormPawnList(pawnList),7);
