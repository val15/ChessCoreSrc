...
namespace ChessCore.Test
{
    ...
    public class ChessEngine1Test
    {
        ...
        private ChessEngine1 _chessEngine;
        public ChessEngine1Test()
        {
            _chessEngine = new ChessEngine1();
           // _chessEngine = new ChessEnginTestCupurMinMax();
        }
 ...
 */
        ...
        /*tsiry;28-10-2021*/
        [TestMethod]
        public void T78ProtectionDuRookDesNoirs()
        {
        ...
        * */
        ...
        [TestMethod]
        public void T33bLePionBlancDoitPrendreLeCavalierOuLeFoueEnD5()
        {
        ...
        /*tsiry;23-05-2022*/
        [TestMethod]
        public void T95BLeCavalierBlanchDoitAttaquerEnF2()
        {
        ...
        [TestMethod]
        public void T100BlackG6ToF5Prim()
        {
        ...
        [TestMethod]
        public void T105BlackC6ToD4Prim()//>> ONLY BEST L5
        {
        ...
        [TestMethod]
        public void T134_B_ToD2()
        {

            var computerColore = "Black";
            var testName = "T134_B_NotToD2";
            var testPath = Path.Combine(testsDirrectory, testName);
            var pawnList = Chess2Utils.LoadFromDirectorie(testPath);
...
/*
        ...
        public void T137_W_A3toD6()
        {
            ...
            {
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardFormPawnListCE(pawnList));
                Assert.IsFalse(nodeResult.Location == "a3" && nodeResult.BestChildPosition == "d6");
