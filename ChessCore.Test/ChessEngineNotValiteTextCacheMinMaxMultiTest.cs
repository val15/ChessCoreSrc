...
{
    [TestClass]
    public class ChessEngineNotValiteTextCacheMinMaxMultiTest
    {
        ...
        private ChessEngineNotValiteTextCacheMinMaxMulti _chessEngine;
        public ChessEngineNotValiteTextCacheMinMaxMultiTest()
        {
            _chessEngine = new ChessEngineNotValiteTextCacheMinMaxMulti();
        }
