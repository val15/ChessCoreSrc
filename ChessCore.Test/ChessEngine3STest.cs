...
{
    [TestClass]
    public class ChessEngine3STest
    {
        ...
        private ChessEngine3S _chessEngine;
        public ChessEngine3STest()
        {
             _chessEngine = new ChessEngine3S();
        }
    ...
    */
        ...
        * */
        ...
        public void T115_W_F3toG5()//TO DEFINE L3(20) OK
        {
            ...
            {
                var nodeResult = _chessEngine.GetBestModeCE(computerColore, Chess2Utils.GenerateBoardFormPawnListCE(pawnList));
                Assert.IsNull(nodeResult.EquivalentBestNodeCEList);
